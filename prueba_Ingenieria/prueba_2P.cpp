...
public:
    Prestamo(string aprobacion, string consignacion, vector<string> pagos)
...
int main() {
    // Crear un cliente
    Cliente cliente("001", "1234567890", "Juan", "Pérez", "Av. Siempre Viva 123", "juan.perez@email.com", "555-1234");

    // Crear una cuenta
    Cuenta cuenta("123-456-789", "Cuenta de Ahorros");

    // Agregar tarjetas de débito y crédito
    Tarjeta tarjetaDebito("1111-2222-3333-4444", "Juan Pérez", 123, true);
    TarjetaCredito tarjetaCredito("5555-6666-7777-8888", "Juan Pérez", 456, true, "12", "2028");
